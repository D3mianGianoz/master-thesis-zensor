...
\end{enumerate}
As such Zensor takes end-to-end responsibility in monitoring the health and efficiency of structures and processes
\todo{EB2DG: ``we'll dive'' troppo informale}
we'll dive in these aspect in the following subsection.
\begin{figure}[ht]
	\begin{tikzcd}
...
\todo{EB2DG: il seguente dovrebbe essere un itemize?}
...
\todo{EB2DG: non capisco la frase ``Push the button...''}
...
The reasons for having two paths with separate initial phases are several. One important factor is the current global semi-conductor and chip shortage~\cite{Article:bbcnews_2021_chip},
