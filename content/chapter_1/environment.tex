...
\begin{itemize}
    \item \textbf{\ac{ppm}}, more commonly referred to planned maintenance
          ...
          \end{itemize}
    \item \textbf{\ac{PdM}} is intended to assist in determining the state of in-service equipment, so that maintenance can be scheduled.
          ...
          As a result, it is viewed as condition-based maintenance which is carried out in accordance with estimations of an item's degradation status.
    ...
    \item \textbf{\ac{cbm}} to put it succinctly, is \textit{maintenance when it is needed}. Although being chronologically much older,
          ...
          connectivity abilities are used, to help schedule preventive maintenance tasks.
...
Today, most often, technical data sheets coupled with the knowledge of a few of unique experienced individuals are used to determine when the asset requires maintenance.
...
but it will also have a serious impact on your plant's efficiency by increasing uptime and lowering the occurrence of unexpected mechanical breakdowns~\cite{Misc:vaningelgem_2020_what}.
