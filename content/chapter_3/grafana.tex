...
% \todo{EB: non capisco le virgole di seguito. ``system''?}
...
\begin{figure}[ht]
    ...
    \caption{Official data and insights on coronavirus (Source: \href{https://coronavirus.data.gov.uk/)}{UK}) }
...
\begin{table}[!ht]
    ...
    \begin{tabular}{|l|l|l|}
        \hline
        Example relative range & From:      & To:        \\ \hline
