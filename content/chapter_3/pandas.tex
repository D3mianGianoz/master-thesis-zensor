...
with important code paths implemented in Cython\footnote{Cython is a static Phyton compiler capable of using highly optimized C libraries \url{https://cython.org/}}
