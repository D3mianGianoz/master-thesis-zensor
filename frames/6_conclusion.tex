...
\begin{frame}{Conclusion}{Important subtitle}
    ...
    \begin{alertblock}{``Simplicity''} % , which include complex analysis,
        ...
        It is crucial to offer complex and exhaustive technological solutions, but the key is to try to make sure that the outcome is simple and clear. % for the end consumer. 
    \end{alertblock}
